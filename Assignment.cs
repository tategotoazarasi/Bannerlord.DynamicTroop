...
public class Assignment : IComparable {
	...
	public bool IsUnderEquipped { get; set; }
	...
	public void MarkSlotAsTemporary(EquipmentIndex slot, ItemObject item) {
		_temporaryItemIdBySlot[slot] = item.StringId;
	}

	public bool IsTemporarySlot(EquipmentIndex slot, ItemObject? item) {
		return item != null && _temporaryItemIdBySlot.TryGetValue(slot, out var itemId) && item.StringId == itemId;
	}
